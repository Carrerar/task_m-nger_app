...
`sw.js` cache theo phiên bản (`focus-board-v1`). Khi sửa code, tăng số
phiên bản trong `sw.js` (ví dụ `focus-board-v2`) để client nạp bản mới; cache
cũ sẽ tự bị xóa ở lần kích hoạt kế tiếp.
